...
public class PageContentControllerTest {
    ...
    private static Logger logger = LoggerFactory.getLogger(PageContentControllerTest.class);
    ...
    public void list() throws Exception {
        ...
        RequestBuilder requestBuilder = MockMvcRequestBuilders.post("/api/PageContentTable/list")
...
//        JSONAssert.assertEquals(expected,mvcResult.getResponse().getContentAsString(),false);
    ...
    public void create() throws Exception {
        pageContentDAO pageContent = new pageContentDAO();

        pageContent.setContent("test content");
        pageContent.setTitle("test_title");
        pageContent.setSubtitle("test_subtitle");
        String content = JSONObject.toJSONString(pageContent);

        RequestBuilder requestBuilder = MockMvcRequestBuilders.post("/api/PageContentTable/create")
                .contentType(MediaType.APPLICATION_JSON_UTF8) //需要指定 只对post请求有效
                .content(content);
        MvcResult mvcResult = mockMvc.perform((requestBuilder)).andExpect(status().isOk()).andReturn();
        String stringResult = mvcResult.getResponse().getContentAsString();
...
//        JSONAssert.assertEquals(expected,mvcResult.getResponse().getContentAsString(),false);
    ...
    public void update() throws Exception {
        ...
        pageContent.setId(23);
        pageContent.setContent("test content");
        pageContent.setTitle("test_title_changed");
        pageContent.setSubtitle("test_subtitle_changed");
        String content = JSONObject.toJSONString(pageContent);

        RequestBuilder requestBuilder = MockMvcRequestBuilders.post("/api/PageContentTable/update")
                .contentType(MediaType.APPLICATION_JSON_UTF8) //需要指定 只对post请求有效
                .content(content);
        MvcResult mvcResult = mockMvc.perform((requestBuilder)).andExpect(status().isOk()).andReturn();
        String stringResult = mvcResult.getResponse().getContentAsString();
...
//        JSONAssert.assertEquals(expected,mvcResult.getResponse().getContentAsString(),false);
    ...
    public void remove() throws Exception {
        ...
        RequestBuilder requestBuilder = MockMvcRequestBuilders.post("/api/PageContentTable/remove")
                .contentType(MediaType.APPLICATION_JSON_UTF8) //需要指定 只对post请求有效
                .content(content);
        MvcResult mvcResult = mockMvc.perform((requestBuilder)).andExpect(status().isOk()).andReturn();
        String stringResult = mvcResult.getResponse().getContentAsString();
